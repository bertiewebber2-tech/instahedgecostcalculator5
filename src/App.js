...
const hedgeTypes = [
  {
    ...
    image: "/Bay.jpg",
    sizes: [
      { label: "100-125cm", pricePerMeter: 70 },
      { label: "150-175cm", pricePerMeter: 80 },
      { label: "175-200cm", pricePerMeter: 105 },
    ],
  },
  {
    name: "Cherry Laurel",
    ...
    sizes: [
      { label: "80-100cm", pricePerMeter: 36 },
      { label: "125-150cm", pricePerMeter: 59 },
      { label: "175-200cm", pricePerMeter: 95 },
    ],
  },
  {
    ...
    sizes: [
      { label: "80-100cm", pricePerMeter: 48 },
      { label: "125-150cm", pricePerMeter: 74 },
      { label: "175-200cm", pricePerMeter: 105 },
    ],
  },
  {
    ...
    sizes: [
      { label: "80-100cm", pricePerMeter: 49 },
      { label: "125-150cm", pricePerMeter: 76 },
      { label: "175-200cm", pricePerMeter: 109 },
    ],
  },
  {
    ...
    sizes: [
      { label: "80-100cm", pricePerMeter: 36 },
      { label: "125-150cm", pricePerMeter: 57 },
      { label: "175-200cm", pricePerMeter: 95 },
    ],
  },
  {
    ...
    sizes: [
      { label: "80-100cm", pricePerMeter: 46 },
      { label: "125-150cm", pricePerMeter: 69 },
      { label: "175-200cm", pricePerMeter: 105 },
    ],
  },
  {
    ...
    sizes: [
      { label: "80-100cm", pricePerMeter: 38 },
      { label: "125-150cm", pricePerMeter: 62 },
      { label: "150-200cm", pricePerMeter: 95 },
    ],
  },
  {
    name: "Glossy Privet",
    ...
    sizes: [
      { label: "80-100cm", pricePerMeter: 36 },
      { label: "125-150cm", pricePerMeter: 57 },
      { label: "150-175cm", pricePerMeter: 95 },
    ],
  },
  {
    name: "Yew",
    ...
    sizes: [
      { label: "80-100cm", pricePerMeter: 48 },
      { label: "125-150cm", pricePerMeter: 79 },
      { label: "150-175cm", pricePerMeter: 115 },
    ],
  },
];
...
export default function App() {
  ...
  const getLabourRate = () => {
    ...
    if (selectedSize.label.includes("Large")) return 30;
    return 25; // small or medium
  };
  const totalCost = () => {
    if (!selectedSize || !length) return 0;
    const plantCost = selectedSize.pricePerMeter * parseFloat(length);
    const labourCost = includeLabour ? getLabourRate() * parseFloat(length) : 0;
        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-[#74875b] px-4">
          <div className="bg-white p-8 rounded-xl shadow-md w-full max-w-md text-center">
            ...
            <p className="text-sm text-gray-600 mt-3 mb-4">
              We operate within 60km of Eastbourne
            </p>
            ...
            {selectedHedge?.sizes.map((size, index) => {
              ...
              return (
                <div
                  ...
                  className="w-40 h-48 bg-[#e4d8b4] rounded-lg shadow-md flex flex-col items-center justify-center cursor-pointer hover:scale-105 transition-transform"
                >
                  <img
                  ...
                  <p className="text-xs text-gray-700 text-center mt-1">
                    £{size.pricePerMeter.toFixed(2)} / meter
                  </p>
                </div>
              );
            })}
            ...
            <div className="bg-white p-6 rounded-2xl shadow w-full max-w-md text-left">
              ...
              <ul className="text-sm space-y-2">
                ...
                <li>
                  ...
                  {includeLabour
                    ? (getLabourRate() * parseFloat(length)).toFixed(2)
                    : "0.00"}
                </li>
                <li>
